...
def parse_args():
    ...
    parser.add_argument('-i', '--csvPath', type=Path, help='path to csv file', default='results/std_error_agg.csv')
    parser.add_argument('-t', '--targetvar', type=str, help='csv variable to plot', default='std_error')
    parser.add_argument('-n', '--plotName', type=Path, help='path to store the plot', default='images/std_error_artificial.png')
